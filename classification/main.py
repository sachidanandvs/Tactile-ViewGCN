...
parser.add_argument('--dataset', default='/home/sachi/Desktop/college_project/data/classification_lite/metadata.mat', help="Path to metadata.mat file.")
...
class Trainer(object):
    ...
    def step(self, data_loader, epoch, isTrain = True, sinkName = None):
        ...
        for i, (inputs) in enumerate(data_loader):
            ...
            print(inputsDict['image'].size())
            print(inputsDict['pressure'].size())
            print(inputsDict['objectId'].size())
            print(inputsDict['objectId'])
